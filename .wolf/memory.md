...
| 22:41 | Python IAM seeder (users/teams/roles/segments/tenant) replacing Flyway data-seeds V4/V5/V7/V8/V9 | scripts/seed-iam-users.py, seed-all.sh, infra/seeder/Dockerfile, docker-compose.yml, iam migrations V4/5/7/8/9, tests/iam-seeder/ | 5/5 pytest green + LIVE /auth/token 200 for 5 personas (401 on wrong pw), idempotent, demo untouched | ~35k |
