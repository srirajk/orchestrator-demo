/**
 * Wire types for the Conduit gateway.
 *
 * These mirror the OpenAI-compatible chat surface and the gateway's glass-box
 * trace stream / admin manifest endpoints. Kept framework-agnostic so any UI
 * (React, Svelte, a CLI, tests) can consume them.
 */
...
/** OpenAI-compatible streaming chunk (one SSE `data:` frame). */
