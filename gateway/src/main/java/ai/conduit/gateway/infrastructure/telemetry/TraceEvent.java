 ...
 *   <li>{@code plan_graph}        — {@link ai.conduit.gateway.infrastructure.telemetry.event.PlanGraphData} — the resolved multi-step DAG (DAG path only)</li>
 *   <li>{@code gate}             — {@link ai.conduit.gateway.infrastructure.telemetry.event.GateData} — one authorization gate's pass/deny + reason</li>
