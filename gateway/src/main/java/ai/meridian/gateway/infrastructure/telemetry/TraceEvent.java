 ...
 * <ul>
 *   <li>{@code request_start}     — {@link ai.meridian.gateway.infrastructure.telemetry.event.RequestStartData}</li>
 *   <li>{@code intent_classified} — {@link ai.meridian.gateway.infrastructure.telemetry.event.IntentClassifiedData}</li>
 *   <li>{@code agents_resolved}   — {@link ai.meridian.gateway.infrastructure.telemetry.event.AgentsResolvedData}</li>
 *   <li>{@code entitlement_check} — {@link ai.meridian.gateway.infrastructure.telemetry.event.EntitlementCheckData}</li>
 *   <li>{@code agent_start}       — {@link ai.meridian.gateway.infrastructure.telemetry.event.AgentStartData}</li>
 *   <li>{@code agent_complete}    — {@link ai.meridian.gateway.infrastructure.telemetry.event.AgentCompleteData}</li>
 *   <li>{@code synthesis_start}   — {@link ai.meridian.gateway.infrastructure.telemetry.event.SynthesisStartData}</li>
 *   <li>{@code request_complete}  — {@link ai.meridian.gateway.infrastructure.telemetry.event.RequestCompleteData}</li>
 * </ul>
 */
