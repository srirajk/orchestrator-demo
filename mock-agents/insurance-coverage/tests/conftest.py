"""Shared pytest fixtures for the insurance-coverage service.
...
def mint_token(tenant_id, sub="uw_sam", audience=None, issuer=TEST_ISSUER,
...
def auth_headers(tenant_id, sub="uw_sam", x_tenant_id=None, **kw):
